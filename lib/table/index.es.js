import { defineComponent, ref, computed, watch, onMounted, resolveComponent, resolveDirective, openBlock, createElementBlock, withDirectives, createBlock, mergeProps, unref, withCtx, Fragment, renderList, createVNode, createElementVNode, renderSlot, withModifiers, createTextVNode, toDisplayString, resolveDynamicComponent, createCommentVNode, normalizeStyle, isRef } from "vue";
const toLine = (value) => {
      ...
      return openBlock(), createElementBlock("div", null, [
        withDirectives((openBlock(), createBlock(_component_el_table, mergeProps(_ctx.$attrs, {
          ...
          default: withCtx(() => [
              ...
              return openBlock(), createBlock(_component_el_table_column, {
                ...
                default: withCtx((scope) => [
                  scope.row.rowEdit ? (openBlock(), createBlock(_component_el_input, {
                    ...
                    editCell.value === scope.$index + scope.column.id ? (openBlock(), createElementBlock("div", _hoisted_1, [
                      createVNode(_component_el_input, {
                        modelValue: scope.row[item.prop],
                        "onUpdate:modelValue": ($event) => scope.row[item.prop] = $event,
                        size: "small"
                      }, null, 8, ["modelValue", "onUpdate:modelValue"]),
                      createElementVNode("div", { onClick: clickEditCell }, [
                        _ctx.$slots.editCell ? renderSlot(_ctx.$slots, "editCell", {
                          ...
                          createVNode(_component_el_icon_close, {
                            class: "close",
                            onClick: withModifiers(($event) => cancel(scope, item), ["stop"])
                          }, null, 8, ["onClick"])
                        ]))
                      ])
                      ...
                      item.slot ? renderSlot(_ctx.$slots, item.slot, {
                        key: 0,
                        scope
                      }, void 0, true) : renderSlot(_ctx.$slots, "default", { key: 1 }, () => [
                        createTextVNode(toDisplayString(scope.row[item.prop]), 1)
                      ], true),
                      item.editable ? (openBlock(), createBlock(resolveDynamicComponent(`el-icon-${unref(toLine)(__props.editIcon)}`), {
                        key: 2,
                        class: "edit",
                        onClick: withModifiers(($event) => clickEdit(scope, item), ["stop"])
            ...
            createVNode(_component_el_table_column, {
              ...
              _: 3
            }, 8, ["prop", "label", "align", "width"])
          ]),
          _: 3
        }, 16, ["data", "element-loading-text", "element-loading-background", "element-loading-svg", "element-loading-svg-view-box"])), [
        ...
        __props.pagination ? (openBlock(), createElementBlock("div", {
          ...
          style: normalizeStyle({
            justifyContent: unref(paginationJustify)
          })
        }, [
...
var table = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-2f8a7fda"]]);
var index = {
  install(app) {
