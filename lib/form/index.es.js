import { defineComponent, ref, watch, onMounted, resolveComponent, openBlock, createElementBlock, unref, createBlock, mergeProps, withCtx, Fragment, renderList, resolveDynamicComponent, renderSlot, createCommentVNode, createVNode, nextTick } from "vue";
...
const _hoisted_1 = { class: "ele-cpn-wrapper" };
const _hoisted_2 = {
  key: 2,
  id: "editor"
};
  ...
  setup(__props, { expose, emit: emits }) {
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", _hoisted_1, [
        unref(model) ? (openBlock(), createBlock(_component_el_form, mergeProps({
          key: 0,
          ref_key: "form",
          ref: form
        }, _ctx.$attrs, {
            ...
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.options, (item, index2) => {
              return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                !item.children || !item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                  ...
                  default: withCtx(() => [
                    item.type !== "upload" && item.type !== "editor" ? (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps({ key: 0 }, item.attrs, {
                      modelValue: unref(model)[item.prop],
                      "onUpdate:modelValue": ($event) => unref(model)[item.prop] = $event
                    }), null, 16, ["modelValue", "onUpdate:modelValue"])) : item.type === "upload" ? (openBlock(), createBlock(_component_el_upload, mergeProps({ key: 1 }, item.uploadAttrs, {
                      ...
                      _: 2
                    }, 1040)) : (openBlock(), createElementBlock("div", _hoisted_2))
                  ]),
                  _: 2
                ...
                item.children && item.children.length ? (openBlock(), createBlock(_component_el_form_item, {
                  ...
                  default: withCtx(() => [
                    (openBlock(), createBlock(resolveDynamicComponent(`el-${item.type}`), mergeProps(item.attrs, {
                      ...
                      default: withCtx(() => [
                        (openBlock(true), createElementBlock(Fragment, null, renderList(item.children, (child, index22) => {
...
var index = {
  install(app) {
    app.component("config-form", _sfc_main);
  }
};
