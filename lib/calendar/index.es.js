...
function b$1(n2) {
  (!n2.__d && (n2.__d = true) && t.push(n2) && !g$2.__r++ || o$1 !== l$1.debounceRendering) && ((o$1 = l$1.debounceRendering) || setTimeout)(g$2);
}
function g$2() {
  for (var n2; g$2.__r = t.length; )
    n2 = t.sort(function(n3, l2) {
      ...
      n3.__d && (o2 = (t2 = (l2 = n3).__v).__e, (r2 = l2.__P) && (u2 = [], (i = s({}, t2)).__v = t2.__v + 1, j$2(r2, t2, i, l2.__n, void 0 !== r2.ownerSVGElement, null != t2.__h ? [o2] : null, u2, null == o2 ? _(t2) : o2, t2.__h), z(u2, t2), t2.__e != o2 && k$1(t2)));
    });
}
function w$1(n2, l2, u2, i, t2, o2, r2, c2, s2, a2) {
  var h2, y2, d2, k2, b2, g2, w2, x2 = i && i.__k || e$1, C2 = x2.length;
  for (u2.__k = [], h2 = 0; h2 < l2.length; h2++)
    if (null != (k2 = u2.__k[h2] = null == (k2 = l2[h2]) || "boolean" == typeof k2 ? null : "string" == typeof k2 || "number" == typeof k2 || "bigint" == typeof k2 ? v$1(null, k2, null, null, k2) : Array.isArray(k2) ? v$1(p, { children: k2 }, null, null, null) : k2.__b > 0 ? v$1(k2.type, k2.props, k2.key, null, k2.__v) : k2)) {
...
function C$1(n2, l2, u2, i, t2) {
  var o2;
  for (o2 in u2)
    "children" === o2 || "key" === o2 || o2 in l2 || H$1(n2, o2, null, u2[o2], i);
  for (o2 in l2)
    t2 && "function" != typeof l2[o2] || "children" === o2 || "key" === o2 || "value" === o2 || "checked" === o2 || u2[o2] === l2[o2] || H$1(n2, o2, l2[o2], u2[o2], i);
}
function $$1(n2, l2, u2) {
  ...
  try {
    n:
      if ("function" == typeof H2) {
        ...
        h2.state = h2.__s, null != h2.getChildContext && (t2 = s(s({}, t2), h2.getChildContext())), v2 || null == h2.getSnapshotBeforeUpdate || (k2 = h2.getSnapshotBeforeUpdate(y2, _2)), $2 = null != a2 && a2.type === p && null == a2.key ? a2.props.children : a2, w$1(n2, Array.isArray($2) ? $2 : [$2], u2, i, t2, o2, r2, f2, e2, c2), h2.base = u2.__e, u2.__h = null, h2.__h.length && f2.push(h2), b2 && (h2.__E = h2.__ = null), h2.__e = false;
      } else
        null == r2 && u2.__v === i.__v ? (u2.__k = i.__k, u2.__e = i.__e) : u2.__e = L$1(i.__e, u2, i, t2, o2, r2, f2, c2);
    (a2 = l$1.diffed) && a2(u2);
  } catch (n3) {
...
function L$1(l2, u2, i, t2, o2, r2, e2, c2) {
  ...
  if (null === d2)
    ...
    if (C$1(l2, p2, y2, o2, c2), v2)
      u2.__k = [];
    else if (k2 = u2.props.children, w$1(l2, Array.isArray(k2) ? k2 : [k2], u2, i, t2, o2 && "foreignObject" !== d2, r2, e2, r2 ? r2[0] : i.__k && _(i, 0), c2), null != r2)
      for (k2 = r2.length; k2--; )
...
function N(n2, u2, i) {
  ...
  i || null == n2.__e || a$1(n2.__e), n2.__e = n2.__d = void 0;
}
...
function P$1(u2, i, t2) {
  var o2, r2, e2;
  l$1.__ && l$1.__(u2, i), r2 = (o2 = "function" == typeof t2) ? null : t2 && t2.__k || i.__k, e2 = [], j$2(i, u2 = (!o2 && t2 || i).__k = h(p, null, [u2]), r2 || f$1, f$1, void 0 !== i.ownerSVGElement, !o2 && t2 ? [t2] : r2 ? null : i.firstChild ? n.call(i.childNodes) : null, e2, !o2 && t2 ? t2 : r2 ? r2.__e : i.firstChild, o2), z(e2, u2);
}
function B(n2, l2) {
...
n = e$1.slice, l$1 = { __e: function(n2, l2, u2, i) {
  ...
  var u2;
  u2 = null != this.__s && this.__s !== this.state ? this.__s : this.__s = s({}, this.state), "function" == typeof n2 && (n2 = n2(s({}, u2), this.props)), n2 && s(u2, n2), null != n2 && this.__v && (l2 && this.__h.push(l2), b$1(this));
...
l$1.__b = function(n2) {
  ...
  o2 && (r === u ? (o2.__h = [], u.__h = [], o2.__.forEach(function(n3) {
    n3.__N && (n3.__ = n3.__N), n3.__V = f, n3.__N = n3.o = void 0;
  })) : (o2.__h.forEach(j$1), o2.__h.forEach(k), o2.__h = [])), r = u;
}, l$1.diffed = function(t2) {
  v && v(t2);
  var i = t2.__c;
  i && i.__H && (i.__H.__h.length && (1 !== c.push(i) && o === l$1.requestAnimationFrame || ((o = l$1.requestAnimationFrame) || function(n2) {
    var t3, u2 = function() {
      clearTimeout(r2), g$1 && cancelAnimationFrame(t3), setTimeout(n2);
    }, r2 = setTimeout(u2, 100);
    g$1 && (t3 = requestAnimationFrame(u2));
  })(b)), i.__H.__.forEach(function(n2) {
    n2.o && (n2.__H = n2.o), n2.__V !== f && (n2.__ = n2.__V), n2.o = void 0, n2.__V = f;
  })), r = u = null;
...
(C.prototype = new d()).isPureReactComponent = true, C.prototype.shouldComponentUpdate = function(n2, t2) {
...
l$1.vnode = function(n2) {
  ...
  if ("string" == typeof t2) {
    ...
    for (var o2 in r2 = {}, e2) {
      var i = e2[o2];
      $ && "children" === o2 && "noscript" === t2 || "value" === o2 && "defaultValue" in e2 && null == i || ("defaultValue" === o2 && "value" in e2 && null == e2.value ? o2 = "value" : "download" === o2 && true === i ? i = "" : /ondoubleclick/i.test(o2) ? o2 = "ondblclick" : /^onchange(textarea|input)/i.test(o2 + t2) && !j(e2.type) ? o2 = "oninput" : /^onfocus$/i.test(o2) ? o2 = "onfocusin" : /^onblur$/i.test(o2) ? o2 = "onfocusout" : /^on(Ani|Tra|Tou|BeforeInp|Compo)/.test(o2) ? o2 = o2.toLowerCase() : u2 && P.test(o2) ? o2 = o2.replace(/[A-Z0-9]/g, "-$&").toLowerCase() : null === i && (i = void 0), /^oninput$/i.test(o2) && (o2 = o2.toLowerCase(), r2[o2] && (o2 = "oninputCapture")), r2[o2] = i);
    }
    "select" == t2 && r2.multiple && Array.isArray(r2.value) && (r2.value = x(e2.children).forEach(function(n3) {
      n3.props.selected = -1 != r2.value.indexOf(n3.props.value);
    })), "select" == t2 && null != r2.defaultValue && (r2.value = x(e2.children).forEach(function(n3) {
...
var index = {
  install(app) {
    app.component("calendar", _sfc_main);
  }
};
