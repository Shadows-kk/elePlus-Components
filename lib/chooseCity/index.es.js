import { getCurrentScope, onScopeDispose, watch, unref, warn, ref, getCurrentInstance, inject, computed, defineComponent, onBeforeUnmount, toRef, openBlock, createBlock, Transition, withCtx, withDirectives, createElementVNode, normalizeClass, normalizeStyle, vShow, createElementBlock, Fragment, createVNode, nextTick, provide, reactive, onMounted, onUpdated, resolveDynamicComponent, renderSlot, createCommentVNode, resolveComponent, toDisplayString, renderList, createTextVNode } from "vue";
var city = {
  "cities": {
    "A": [{
      "id": 56,
...
var Scrollbar = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["__file", "/home/runner/work/element-plus/element-plus/packages/components/scrollbar/src/scrollbar.vue"]]);
...
const _hoisted_5 = { class: "cityGroup" };
const _hoisted_6 = ["onClick"];
const _hoisted_7 = { class: "province" };
const _hoisted_8 = ["onClick"];
const _hoisted_9 = { class: "provinceGroup" };
const _hoisted_10 = ["onClick"];
const _sfc_main = /* @__PURE__ */ defineComponent({
  __name: "index",
  emits: ["selectCity", "selectProvince"],
  setup(__props, { emit: emits }) {
    ...
    watch(() => radioValue.value, (val) => {
      isActiveIndex.value = 0;
    });
    const handleClick = () => {
      visible.value = !visible.value;
    };
    const clickLetter = (item, index2) => {
      isActiveIndex.value = index2;
      const dom = document.getElementById(item);
      if (dom) {
        dom.scrollIntoView(true);
      }
    };
    const cityItemClick = (v) => {
      result.value = v.name;
      visible.value = false;
      emits("selectCity", v);
    };
    ...
    const changeSelect = (val) => {
      const city2 = allCities.value.find((item) => {
        return item.id === val;
      });
      result.value = city2 == null ? void 0 : city2.name;
      if (radioValue.value === "\u6309\u57CE\u5E02") {
        emits("selectCity", city2);
      } else {
        emits("selectProvince", city2);
      }
    };
    return (_ctx, _cache) => {
      ...
      return openBlock(), createBlock(_component_el_popover, {
        ...
        default: withCtx(() => [
          createElementVNode("div", _hoisted_2, [
            ...
            radioValue.value === "\u6309\u57CE\u5E02" ? (openBlock(), createElementBlock(Fragment, { key: 0 }, [
              createElementVNode("div", _hoisted_3, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(cities.value), (item, index2) => {
                  return openBlock(), createElementBlock("div", {
                    class: normalizeClass(["city-item", { acitiveItem: unref(isActiveIndex) === index2 }]),
                    onClick: ($event) => clickLetter(item, index2),
                    key: index2
                        ...
                        createVNode(_component_el_col, { span: 22 }, {
                          default: withCtx(() => [
                            createElementVNode("div", _hoisted_5, [
                              (openBlock(true), createElementBlock(Fragment, null, renderList(cities.value[item], (v, i) => {
                                return openBlock(), createElementBlock("div", {
                                  class: "cityItem",
                                  onClick: ($event) => cityItemClick(v),
                                  key: v.id
                                }, toDisplayString(v.name), 9, _hoisted_6);
                              }), 128))
                            ])
                          ]),
                          _: 2
              ...
              createElementVNode("div", _hoisted_7, [
                (openBlock(true), createElementBlock(Fragment, null, renderList(Object.keys(provinces.value), (item, index2) => {
                  return openBlock(), createElementBlock("div", {
                    class: normalizeClass(["province-item", { acitiveItem: unref(isActiveIndex) === index2 }]),
                    onClick: ($event) => clickLetter(item, index2),
                    key: index2
                  }, toDisplayString(item), 11, _hoisted_8);
                }), 128))
              ]),
              createVNode(unref(ElScrollbar), {
                "max-height": "300px",
                ...
                default: withCtx(() => [
                  (openBlock(true), createElementBlock(Fragment, null, renderList(Object.values(provinces.value), (item, index2) => {
                    return openBlock(), createElementBlock(Fragment, { key: index2 }, [
                      (openBlock(true), createElementBlock(Fragment, null, renderList(item, (item1, index22) => {
                        return openBlock(), createBlock(_component_el_row, {
                          key: index22,
                          id: item1.id
                        }, {
                            ...
                            createVNode(_component_el_col, { span: 21 }, {
                              default: withCtx(() => [
                                createElementVNode("div", _hoisted_9, [
                                  (openBlock(true), createElementBlock(Fragment, null, renderList(item1.data, (v, i) => {
                                    return openBlock(), createElementBlock("div", {
                                      class: "provinceItem",
                                      onClick: ($event) => provinceItemClick(v),
                                      key: i
                                    }, toDisplayString(v), 9, _hoisted_10);
                                  }), 128))
                                ])
                              ]),
                              _: 2
...
var chooseCity = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-17d85060"]]);
var index = {
  install(app) {
